...
public class Stock implements Serializable {
    ...
    private int[] fotos = {R.mipmap.ic_apletizer, R.mipmap.ic_arrugadas, R.mipmap.ic_calamares, R.mipmap.ic_cerveza_tropical,
            ...
            R.mipmap.ic_burguer, R.mipmap.ic_burguer, R.mipmap.ic_nugget, R.mipmap.ic_nestea, R.mipmap.ic_papas,
    ...
    Stock(){
        for (int i = 0; i < nombres.length; i++) {
            Productos p = new Productos(nombres[i], precios[i], fotos[i], mayores[i]);
            list.add(p);
        }
    }
